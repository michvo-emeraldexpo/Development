...
##myPassword = ""
##myPrivateKeyFilePath = "D:\\Development\\SFTPGateway\\mcftp_private_key"
##myLocalFileFolderPath = "D:\\Import\\TMM"
##myRemoteFileFolderPath = "/Triggered_Automations/PaperForm/DailySubscriptions"
##myFileFullName = "v2CustomerSearchCDH_Export_01062021_105900.csv"
##myFileExtension = ".csv"
...
##myKnownHostFilePath = "D:\\Development\\SFTPGateway\\known_hosts"
##myActionType = "Put"
##myFileList = []
##status = ""
##myCnOpts = ""
            ...
            if (myActionType == "Put"):    
                ...
                for attr in directory_structure:
                    if (sftp.exists(attr.filename) == False and attr.filename in myFileList):
                        print("File " + attr.filename + " has not been Uploaded Successfully to Remote Server... ")
            ...
            # File Get Method (Upload)             
                ...
                for entry in os.scandir(myLocalFileFolderPath):
                    if (os.path.isfile(entry.path) == False and os.path.basename(entry.path) in myFileList):
                        print("File " + os.path.basename(entry.path) + " has not been Downloaded Successfully on Local Server... ")
