...
Module main
    Function Main() As Integer
        ...
        FullFilePath = "D:\Import\TMM\TMMCustomer.csv"
        ObjectType = "Customer"
        IssueYear = "2000"
        ...
        Try
            Select Case ObjectType
                Case "Customer"
                    ...
                    Dim TMMObject As New TMMCustomer(ObjectType)
                    ...
                    TMMObject.GenerateFile(FullFilePath, ObjectType, ",")
                Case "Product"
                    Console.WriteLine("Stored Procedure Name: spCustomEmeraldProductSearchCDH_200")
                    Params = {}
                    Dim TMMObject As New TMMProduct(ObjectType)
                ...
                Case "Quote"
                    ...
                    Dim TMMObject As New TMMQuote(ObjectType)
